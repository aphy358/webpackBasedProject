...
jQuery.each(["get","post"],function(i,method){jQuery[method]=function(url,data,callback,type){if(jQuery.isFunction(data)){type=type||callback;callback=data;data=undefined}var layLoading=layer.load();var closeLoading=function(){return layer.close(layLoading)};return jQuery.ajax(jQuery.extend({url:url,type:method,dataType:type,data:data,success:callback,complete:closeLoading},jQuery.isPlainObject(url)&&url))}});


window.placeholder=function(){if($.prototype.placeholder){$('input').placeholder()}};